package com.example.denis.androidfinal.UI;
...
import com.example.denis.androidfinal.R;
import com.example.denis.androidfinal.ViewModels.HomeViewModel;
import com.example.denis.androidfinal.ViewModels.TaskViewModel;
import com.example.denis.androidfinal.vo.RequestObject;
import com.example.denis.androidfinal.vo.ResponseObject;
import com.example.denis.androidfinal.vo.TaskEdit;
...
//        });
    ...
    private void start() {
        Request request = new Request.Builder().url("ws://192.168.43.190:8080/web-tasks").build();
